...
class ConnectionManager
{
	...
	{
		return $this->byId( "repupedes_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "repupedes_at_localhost";
		$data["connName"] = "repupedes at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;web;W3b2015_@;;repupedes;;1"; //currently unused
		
		$this->_connectionsIdByName["repupedes at localhost"] = "repupedes_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "web";
		$data["ODBCPWD"] = "W3b2015_@";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=web;Pwd=W3b2015_@;Database=repupedes;OPTION=3";
		$connectionsData["repupedes_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["cat_cabcol"] = "repupedes_at_localhost";
		$connectionsIds["cat_cabtam"] = "repupedes_at_localhost";
		$connectionsIds["cat_cabtip"] = "repupedes_at_localhost";
		$connectionsIds["cat_cejas"] = "repupedes_at_localhost";
		$connectionsIds["cat_comp"] = "repupedes_at_localhost";
		$connectionsIds["cat_escolaridad"] = "repupedes_at_localhost";
		$connectionsIds["cat_labios"] = "repupedes_at_localhost";
		$connectionsIds["cat_menton"] = "repupedes_at_localhost";
		$connectionsIds["cat_nariz"] = "repupedes_at_localhost";
		$connectionsIds["cat_ojos"] = "repupedes_at_localhost";
		$connectionsIds["cat_piel"] = "repupedes_at_localhost";
		$connectionsIds["cat_vfacial"] = "repupedes_at_localhost";
		$connectionsIds["desaparecidos2017"] = "repupedes_at_localhost";
