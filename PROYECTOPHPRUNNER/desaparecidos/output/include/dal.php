...
class tDAL
{
	var $tblrepupedes_at_localhost__cat_cabcol;
	var $tblrepupedes_at_localhost__cat_cabtam;
	var $tblrepupedes_at_localhost__cat_cabtip;
	var $tblrepupedes_at_localhost__cat_cejas;
	var $tblrepupedes_at_localhost__cat_comp;
	var $tblrepupedes_at_localhost__cat_escolaridad;
	var $tblrepupedes_at_localhost__cat_labios;
	var $tblrepupedes_at_localhost__cat_menton;
	var $tblrepupedes_at_localhost__cat_nariz;
	var $tblrepupedes_at_localhost__cat_ojos;
	var $tblrepupedes_at_localhost__cat_piel;
	var $tblrepupedes_at_localhost__cat_vfacial;
	var $tblrepupedes_at_localhost__desaparecidos2017;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cat_cabcol", "varname" => "repupedes_at_localhost__cat_cabcol", "altvarname" => "cat_cabcol", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_cabtam", "varname" => "repupedes_at_localhost__cat_cabtam", "altvarname" => "cat_cabtam", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_cabtip", "varname" => "repupedes_at_localhost__cat_cabtip", "altvarname" => "cat_cabtip", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_cejas", "varname" => "repupedes_at_localhost__cat_cejas", "altvarname" => "cat_cejas", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_comp", "varname" => "repupedes_at_localhost__cat_comp", "altvarname" => "cat_comp", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_escolaridad", "varname" => "repupedes_at_localhost__cat_escolaridad", "altvarname" => "cat_escolaridad", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_labios", "varname" => "repupedes_at_localhost__cat_labios", "altvarname" => "cat_labios", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_menton", "varname" => "repupedes_at_localhost__cat_menton", "altvarname" => "cat_menton", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_nariz", "varname" => "repupedes_at_localhost__cat_nariz", "altvarname" => "cat_nariz", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_ojos", "varname" => "repupedes_at_localhost__cat_ojos", "altvarname" => "cat_ojos", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_piel", "varname" => "repupedes_at_localhost__cat_piel", "altvarname" => "cat_piel", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "cat_vfacial", "varname" => "repupedes_at_localhost__cat_vfacial", "altvarname" => "cat_vfacial", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
		$this->lstTables[] = array("name" => "desaparecidos2017", "varname" => "repupedes_at_localhost__desaparecidos2017", "altvarname" => "desaparecidos2017", "connId" => "repupedes_at_localhost", "schema" => "", "connName" => "repupedes at localhost");
	}
