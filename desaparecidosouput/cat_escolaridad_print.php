...
$layout = new TLayout("print", "OfficeDeliciousGray", "MobileDeliciousGray");
$layout->version = 2;
...
$page_layouts["cat_escolaridad_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_escolaridad" );
