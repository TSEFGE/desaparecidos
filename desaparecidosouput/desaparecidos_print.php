...
require_once("include/desaparecidos_variables.php");
...
$page_layouts["desaparecidos_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "desaparecidos" );
