...
class tDAL
{
	var $tbldesaparecidos_at_localhost__cat_cabcol;
	var $tbldesaparecidos_at_localhost__cat_cabtam;
	var $tbldesaparecidos_at_localhost__cat_cabtip;
	var $tbldesaparecidos_at_localhost__cat_cejas;
	var $tbldesaparecidos_at_localhost__cat_comp;
	var $tbldesaparecidos_at_localhost__cat_delito;
	var $tbldesaparecidos_at_localhost__cat_edos;
	var $tbldesaparecidos_at_localhost__cat_escolaridad;
	var $tbldesaparecidos_at_localhost__cat_est_apar;
	var $tbldesaparecidos_at_localhost__cat_estatus;
	var $tbldesaparecidos_at_localhost__cat_labios;
	var $tbldesaparecidos_at_localhost__cat_menton;
	var $tbldesaparecidos_at_localhost__cat_mpos;
	var $tbldesaparecidos_at_localhost__cat_nariz;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "cat_delito", "varname" => "desaparecidos_at_localhost__cat_delito", "altvarname" => "cat_delito", "connId" => "desaparecidos_at_localhost", "schema" => "", "connName" => "desaparecidos at localhost");
		$this->lstTables[] = array("name" => "cat_edos", "varname" => "desaparecidos_at_localhost__cat_edos", "altvarname" => "cat_edos", "connId" => "desaparecidos_at_localhost", "schema" => "", "connName" => "desaparecidos at localhost");
		...
		$this->lstTables[] = array("name" => "cat_est_apar", "varname" => "desaparecidos_at_localhost__cat_est_apar", "altvarname" => "cat_est_apar", "connId" => "desaparecidos_at_localhost", "schema" => "", "connName" => "desaparecidos at localhost");
		$this->lstTables[] = array("name" => "cat_estatus", "varname" => "desaparecidos_at_localhost__cat_estatus", "altvarname" => "cat_estatus", "connId" => "desaparecidos_at_localhost", "schema" => "", "connName" => "desaparecidos at localhost");
		...
		$this->lstTables[] = array("name" => "cat_mpos", "varname" => "desaparecidos_at_localhost__cat_mpos", "altvarname" => "cat_mpos", "connId" => "desaparecidos_at_localhost", "schema" => "", "connName" => "desaparecidos at localhost");
