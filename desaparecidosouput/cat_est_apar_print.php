...
require_once("include/cat_est_apar_variables.php");
...
$page_layouts["cat_est_apar_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_est_apar" );
