...
$layout = new TLayout("edit_basic_2col_center", "OfficeDeliciousGray", "MobileDeliciousGray");
$layout->version = 2;
...
$page_layouts["cat_escolaridad_edit"] = $layout;
...
$keys = array();
$keys["idescolaridad"] = postvalue("editid1");
