...
$nonAdminTablesArr[] = "cat_cabcol";
$nonAdminTablesArr[] = "cat_cabtam";
$nonAdminTablesArr[] = "cat_cejas";
$nonAdminTablesArr[] = "cat_cabtip";
$nonAdminTablesArr[] = "cat_comp";
$nonAdminTablesArr[] = "cat_delito";
$nonAdminTablesArr[] = "cat_edos";
$nonAdminTablesArr[] = "cat_escolaridad";
$nonAdminTablesArr[] = "cat_est_apar";
$nonAdminTablesArr[] = "cat_estatus";
$nonAdminTablesArr[] = "cat_labios";
$nonAdminTablesArr[] = "cat_menton";
$nonAdminTablesArr[] = "cat_mpos";
$nonAdminTablesArr[] = "cat_nariz";
$nonAdminTablesArr[] = "cat_ojos";
$nonAdminTablesArr[] = "cat_piel";
$nonAdminTablesArr[] = "cat_sexo";
$nonAdminTablesArr[] = "cat_valida";
$nonAdminTablesArr[] = "cat_vfacial";
$nonAdminTablesArr[] = "catnacionalidad";
$nonAdminTablesArr[] = "colaboraciones";
$nonAdminTablesArr[] = "desaparecidos";
$nonAdminTablesArr[] = "unidad";
...
$wGroupTableName = $ug_connection->addTableWrappers( "desaparecidos_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "desaparecidos_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "desaparecidos_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue("id")+0);
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "desaparecidos_ugrights" );
	...
	case 'saveMembership':
		...
		$wMemebersTableName = $ug_connection->addTableWrappers( "desaparecidos_ugmembers" );
