...
require_once("include/cat_estatus_variables.php");
...
$page_layouts["cat_estatus_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_estatus" );
