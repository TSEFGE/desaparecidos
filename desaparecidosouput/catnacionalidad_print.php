...
require_once("include/catnacionalidad_variables.php");
...
$page_layouts["catnacionalidad_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "catnacionalidad" );
