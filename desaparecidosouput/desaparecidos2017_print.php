...
require_once("include/desaparecidos2017_variables.php");
...
$layout = new TLayout("print", "Office1DeliciousGray1", "MobileDeliciousGray1");
$layout->version = 2;
...
$page_layouts["desaparecidos2017_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "desaparecidos2017" );
