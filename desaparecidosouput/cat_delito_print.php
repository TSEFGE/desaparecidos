...
require_once("include/cat_delito_variables.php");
...
$page_layouts["cat_delito_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "cat_delito" );
